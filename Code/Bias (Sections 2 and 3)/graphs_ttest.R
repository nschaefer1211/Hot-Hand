# Graphs for confidence intervals and standard errors of t-tests (Figures 3, 6, and 7)
library(Cairo)
...
plot(Shooter, ttest2_sort$adj_diff * 100,
  ylab = "Bias-corrected difference (percentage points)", ylim = c(-90, 95),
  cex = 1.5, type = "p", pch = 16, col = "black"
)
segments(
  x0 = Shooter, x1 = Shooter, y0 = ttest2_sort$adj_diff * 100 - ttest2_sort$se2 * 100,
...
plot(Shooter, ttest3_sort$adj_diff[-26] * 100,
  ylab = "Bias-corrected difference (percentage points)", ylim = c(-100, 100),
  cex = 1.5, type = "p", pch = 16, col = "black"
)
segments(
  x0 = Shooter, x1 = Shooter, y0 = ttest3_sort$adj_diff * 100 - ttest3_sort$se3 * 100,
...
plot(Shooter, ttest4_sort$adj_diff[-c(25, 26)] * 100,
  ylab = "Bias-corrected difference (percentage points)", xlim = c(0, 25), ylim = c(-150, 165),
  cex = 1.5, type = "p", pch = 16, col = "black"
)
segments(
  x0 = Shooter, x1 = Shooter, y0 = ttest4_sort$adj_diff * 100 - ttest4_sort$se4 * 100,
